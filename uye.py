...
"""
class Uye:
    def __init__(self, uye_id, ad, soyad, adres, tel):
        self.uye_id = uye_id
        self.ad = ad
        self.soyad = soyad
        self.adres=adres
...
uye1 = Uye(1, "Ahmet", "Demir", "Ankara", "05078789541")
uye2 = Uye(2, "Ayşe", "Yılmaz", "İstanbul", "05078975412")
uye3 = Uye(3, "Mehmet", "Kara", "İzmir", "05445891230")

# Üye bilgilerini gösterme
uye1.bilgileri_goster()
uye2.bilgileri_goster()
uye3.bilgileri_goster()

# Üye adını güncelleme
uye1.adres_degistir("İzmir")
uye1.bilgileri_goster()

# Üye soyadını güncelleme
